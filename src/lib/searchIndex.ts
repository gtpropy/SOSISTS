...
const pages: SearchResult[] = [
  ...
  { id: "page-robotoshop", title: "RobotoShop", subtitle: "2-day beginner Arduino workshop", category: "Page", href: "/robotoshop", keywords: "robotoshop robotics arduino workshop beginner simon says capstone september" },
...
const sections: SearchResult[] = [
  ...
  { id: "sec-upcoming", title: "What's Next", subtitle: "RobotoShop teaser", category: "Section", href: "/", sectionId: "section-upcoming", keywords: "upcoming events next robotoshop workshop teaser" },
...
const roboWorkshopResults: SearchResult[] = [
  { id: "robo-schedule", title: "RobotoShop Schedule", subtitle: roboWorkshop.days.map((d) => d.title).join(" · "), category: "Workshop", href: "/robotoshop", keywords: "robotoshop schedule day 1 day 2 arduino workshop plan".toLowerCase() },
  { id: "robo-learn", title: "RobotoShop — What You'll Learn", subtitle: roboWorkshop.whatYoullLearn[0], category: "Workshop", href: "/robotoshop", keywords: `arduino code circuits debugging ${roboWorkshop.whatYoullLearn.join(" ")}`.toLowerCase() },
  { id: "robo-capstone", title: "RobotoShop Capstone Project", subtitle: "Day 2 finale — build your own game or gadget", category: "Workshop", href: "/robotoshop", keywords: "capstone project simon says mini games prizes day 2" },
];
